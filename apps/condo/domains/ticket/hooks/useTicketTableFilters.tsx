...
const filterPlaceClassifier = getFilter(['classifierRule', 'place', 'id'], 'array', 'string', 'in')
const filterCategoryClassifier = getFilter(['classifierRule', 'category', 'id'], 'array', 'string', 'in')
